...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  generateTestCases: (ticketData: any, context: string, modelOverride: string) => ipcRenderer.invoke('generate-test-cases', ticketData, context, modelOverride),
  fetchConfluencePage: (pageId: string) => ipcRenderer.invoke('fetch-confluence-page', pageId),
  generateStories: (pageData: any, context: string, modelOverride: string) => ipcRenderer.invoke('generate-stories', pageData, context, modelOverride),
