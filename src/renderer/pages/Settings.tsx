...
const Settings: React.FC = () => {
  ...
  return (
    <div className="container-fluid p-0">
      <div className="p-3 bg-body-tertiary border-bottom shadow-sm d-flex justify-content-between align-items-center sticky-top z-3">
        <button
          type="button"
      ...
      <div className="container p-4" style={{ maxWidth: '848px' }}>
        {statusMessage && (
          <div
